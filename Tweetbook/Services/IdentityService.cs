    ...
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            if (existingUser != null)
            {
                ...
                {
                    Errors = new[] { "Já existe um usuário com este endereço de e-mail." }
                };
            }
        ...
        public async Task<AuthenticationResult> LoginAsync(string email, string password)
        {
            ...
            if (userHasValidPassword == false)
            {
                return new AuthenticationResult
                {
                    Errors = new[] { "A combinação de usuário / senha está errada." }
                };
            }
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            {
                return new AuthenticationResult() { Errors = new[] { "Token invalido." } };
            }
        ...
        private async Task<AuthenticationResult> GenerateAuthenticationResultForUserAsync(IdentityUser user)
        {
            ...
            var refreshToken = new RefreshToken
            {
                ...
                ExpiryDate = DateTime.UtcNow.AddDays(1) //AddMonths(6)
            };
