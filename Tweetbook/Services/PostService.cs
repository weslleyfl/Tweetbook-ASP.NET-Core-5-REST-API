...
namespace Tweetbook.Services
{
    public class PostService : IPostService
    {
        ...
        {
            IQueryable<Post> queryable = _dataContext.Posts.AsQueryable();
        ...
        public async Task<Tag> GetTagByNameAsync(string tagName)
        {
            return await _dataContext.Tags.AsNoTracking()
                .FirstOrDefaultAsync(x => x.Name == tagName.ToLower());
        }
        ...
        public async Task<bool> DeleteTagAsync(string tagName)
        {
            ...
            var postTags = await _dataContext.PostTags
                .AsNoTracking()
                .Where(x => x.TagName == tag.Name)
                .ToListAsync();
        ...
        private async Task AddNewTags(Post post)
        {
            ...
            {
                var existingTag = await _dataContext.Tags
                    .AsNoTracking()
                    .SingleOrDefaultAsync(t => t.Name == tag.TagName);
